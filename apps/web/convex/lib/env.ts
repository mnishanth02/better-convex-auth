...
function validateBackendEnv() {
  ...
  if (parsed.data.GITHUB_CLIENT_ID && !parsed.data.GITHUB_CLIENT_SECRET) {
    console.warn("⚠️  GITHUB_CLIENT_ID is set but GITHUB_CLIENT_SECRET is missing. GitHub OAuth will not work.");
  }
  if (parsed.data.GITHUB_CLIENT_SECRET && !parsed.data.GITHUB_CLIENT_ID) {
    console.warn("⚠️  GITHUB_CLIENT_SECRET is set but GITHUB_CLIENT_SECRET is missing. GitHub OAuth will not work.");
  }
